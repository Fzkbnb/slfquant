...
@Slf4j
public class OKexV5GridUsdtClient extends AbstractGridUsdtClient
{
    private OkexV5CommonApiClient commonApiClient;
    
    public OKexV5GridUsdtClient(QuantGridConfig config, String apiKey, String secretKey, String passPhrase)
    {
