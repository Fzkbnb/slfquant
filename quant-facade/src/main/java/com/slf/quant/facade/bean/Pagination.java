...
public class Pagination implements Serializable
{
    ...
    protected Integer         rows             = GlobalConst.DEFAULT_PAGE_SIZE;
    
    // 当前是第几页
    @ApiModelProperty(value = "当前页数")
    protected Integer         page             = GlobalConst.DEFAULT_CURRENT_PAGE;
    ...
    public void setRows(Integer rows)
    {
        if (rows < 1)
        {
            this.rows = GlobalConst.DEFAULT_PAGE_SIZE;
        }
        else
        {
            this.rows = rows;
    ...
    public void setPage(Integer page)
    {
        if (page < 1)
        {
            this.page = GlobalConst.DEFAULT_CURRENT_PAGE;
        }
        else
        {
            this.page = page;
