...
public class SwapMarketAPIServiceImpl implements SwapMarketAPIService {
     ...
     */
    @Override
    public String getHistoricalFundingRateApi(String instrumentId,String limit) {
        return client.executeSync(api.getHistoricalFundingRateApi(instrumentId,limit));
    }
