 ...
 * @author : yukai
 * @version : 1.0
 * @program : com.blocain.exchange.payment.exchange.huobi
 * @discription :
 * @create : 2018-06-08-17
 **/
public class CreateOrderRequest {
    public static interface OrderType {
         ...
         * 限价买入
         */
        final String BUY_LIMIT = "buy-limit";
        /**
         * 限价卖出
         */
        final String SELL_LIMIT = "sell-limit";
        /**
         * 市价买入
         */
        final String BUY_MARKET = "buy-market";
        /**
         * 市价卖出
         */
        final String SELL_MARKET = "sell-market";
    }
